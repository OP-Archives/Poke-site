          ...
          <Paper sx={{ pl: 6, pr: 6, pt: 2, pb: 2 }}>
            <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', flexDirection: 'column' }}>
              ...
              <Box sx={{ display: 'flex', mt: 2, flexDirection: isMobile ? 'column' : 'row' }}>
                <Button sx={{ m: 1 }} variant="contained" onClick={() => setUi('all')}>
                  ALL
                </Button>
                <Button sx={{ m: 1 }} variant="contained" onClick={() => setUi('denied')}>
                  Denied
                </Button>
                <Button sx={{ m: 1 }} variant="contained" onClick={() => setUi('unapproved')}>
                  Unapproved
                </Button>
                <Button sx={{ m: 1 }} variant="contained" onClick={() => setUi('approved')}>
                  Approved
                </Button>
                <Button sx={{ m: 1 }} variant="contained" onClick={() => setUi('winners')}>
                  Winners
                </Button>
              </Box>
