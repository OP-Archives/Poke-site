  ...
  return (
    <Box sx={{ height: "100%", width: "100%" }}>
      <Box sx={{ display: "flex", flexDirection: isMobile ? "column" : "row", height: "100%", width: "100%" }}>
        ...
        {isMobile && <Divider />}
        {<Chat isMobile={isMobile} vodId={vodId} playerRef={playerRef} playing={playing} currentTime={currentTime} delay={delay} twitchId={twitchId} channel={channel} VODS_API_BASE={VODS_API_BASE} />}
      </Box>
    </Box>
  );
}
